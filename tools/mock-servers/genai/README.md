...
The conformance runner starts it for you when a session declares it; see
[`genai-runner`](../../genai-runner), which wires it in as the
default server for GenAI runs.
