...
#
# These arrived as edits to a provisioning cache rather than as changes here,
# which meant the scenarios relying on them could have broken without anything
# saying so. They are the mock's contract now.
